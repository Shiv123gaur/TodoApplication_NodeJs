...
import 'package:todo_reminder/repositories/calenderRepo.dart';
...
//10.0.2.2:3000
  Future<void>  init() async{
        ...
        Get.lazyPut(()=>CalenderRepo(apiClient: Get.find()),fenix: true);
        //Controllers
        ...
        Get.lazyPut(() => CalenderController(calenderRepo: Get.find()),fenix: true);
  }
