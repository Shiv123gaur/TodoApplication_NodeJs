...
class AuthController extends GetxController {
  ...
  Future<bool> RegisterUser(String email, String password, String name) async {
    ...
    if (response.statusCode == 200) {
      ...
      _user = Userr.fromJson(decodedbody["user"]);
    ...
    try {
      ...
      if (account == null) {
        ...
        if (response.statusCode == 200) {
          ...
          _user = Userr.fromJson(body["user"]);
          update();
          await authRepo.SaveUserToken(token);
          await authRepo.SaveUserDetails(
              _user.name!, _user.email!, _user.profile!);
          await authRepo.Loggedin();
          return true;
        } else {
          var body = jsonDecode(response.body);
  ...
  google_signup() async {
    ...
    if (account == null) {
      ...
      GoogleSignupModel model = GoogleSignupModel(
